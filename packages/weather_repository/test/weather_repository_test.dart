  ...
  group('WeatherRepository', () {
    ...
    group('getWeather', () {
      ...
      test('throws when locationSearch fails', () async {
        ...
        expect(() async => weatherRepository.getWeather(city), throwsA(exception));
      });
      ...
      test('returns correct weather on success (clear)', () async {
        ...
        expect(
          actual,
          Weather(temperature: 42.42, location: city, condition: WeatherCondition.clear),
        );
      });
      ...
      test('returns correct weather on success (cloudy)', () async {
        ...
        expect(
          actual,
          Weather(temperature: 42.42, location: city, condition: WeatherCondition.cloudy),
        );
      });
      ...
      test('returns correct weather on success (rainy)', () async {
        ...
        expect(
          actual,
          Weather(temperature: 42.42, location: city, condition: WeatherCondition.rainy),
        );
      });
      ...
      test('returns correct weather on success (snowy)', () async {
        ...
        expect(
          actual,
          Weather(temperature: 42.42, location: city, condition: WeatherCondition.snowy),
        );
      });
      ...
      test('returns correct weather on success (unknown)', () async {
        ...
        expect(
          actual,
          Weather(temperature: 42.42, location: city, condition: WeatherCondition.unknown),
        );
      });
    });
